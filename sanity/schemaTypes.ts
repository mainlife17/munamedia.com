...
export const caseStudy = defineType({
  ...
  fields: [
    ...
    defineField({ name: 'clientProfile', title: 'Client profile', type: 'text', rows: 3 }),
    defineField({ name: 'executiveSummary', type: 'text', rows: 4 }),
    defineField({ name: 'businessGoal', title: 'Business goal', type: 'text', rows: 3 }),
    ...
    defineField({ name: 'operationalScope', title: 'Operational scope', type: 'array', of: [{ type: 'string' }] }),
    ...
    defineField({ name: 'publicEvidence', title: 'Public evidence', type: 'array', of: [{ type: 'string' }] }),
    defineField({ name: 'whatWorked', type: 'array', of: [{ type: 'string' }] }),
    defineField({ name: 'nextBestAction', title: 'Next data to add', type: 'text', rows: 3 }),
    defineField({ name: 'sourceNotes', title: 'Source notes', type: 'text', rows: 3 }),
